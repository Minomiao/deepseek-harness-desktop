...
| 平台 | 文件 |
|---|---|
| Windows | `DSH Desktop Setup 0.2.0.exe`（安装版）/ `DSH Desktop-0.2.0-win-x64.zip`（免安装，解压即用） |
| macOS (Apple Silicon) | `DSH Desktop-0.2.0-arm64.dmg` |
| Linux | `DSH Desktop-0.2.0.AppImage` |

> macOS 版本未签名，首次打开请右键选择"打开"；Linux 需先 `chmod +x "DSH Desktop-0.2.0.AppImage"`。
...
- 打 tag 自动触发：`git tag v0.2.0 && git push origin v0.2.0`
